...
MODEL_PATH_X = BASE_DIR / "models" / "best_x.pt"   # YOLOv8x ที่เทรนเอง
MODEL_PATH_M = BASE_DIR / "models" / "best_m.pt"   # YOLOv8m ที่เทรนเอง
...
DEVICE         = "cpu"   # ⭐ ถ้าการ์ดจอพอ เปลี่ยนเป็น "cuda" จะลื่นขึ้นมาก
